...
//       });
//     });
//     console.log('out:-- ', dependeciesRequired);
...
// //     // console.log("\nInstalling redux, react-router, react-router-dom, react-redux, and redux-thunk\n".cyan)
// //     shell.exec(`npm install --save redux react-router react-redux redux-thunk `, () => {
...
// //         //   }
// //         //   if(installablePackages[0].length){
// //         //     console.log('tesssssssssssssssssss:-- ', JSON.stringify(installablePackages[0]))
...
// //         //     }
// //         //   }
// //         //   console.log('installablePackages[0].length:---- ',installablePackages[0].length);
// //         //   console.log('dpe:- ',templates[fileName]['dependencies'])
// //         //   console.log('package:--- ', JSON.stringify(templates[fileName]))
// //         //     console.log('devDependencies:- ',templates[fileName]['devDependencies'])
// //         // }
// //         if(fileName && fileName.includes('exe_comand')){
// //             shell.exec(`rm -rf ${appDirectory}/src/${templates[fileName]}`, () => {
// //               console.log(`\nDeleting-------- ${templates[fileName]}\n`.red)
...
// //                 })
// //               })
// //               console.log('dirArray jooin: ', dirArray.join('/'));
// //               fs.writeFile(`${appDirectory}/src/${dirArray.join('/')}`, templates[fileName], function(err) {
// //                 if(err) { return console.log(err) }
// //                 res()
// //               })
...
// //               if(dependeciesRequired['eslint']['value']){
